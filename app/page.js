...
export default function Home() {
  return (
    <>
      ...
      <div className="bg-white h-1  opacity-10"></div>
      <div className="text-white container ml-68 w-[calc(100vw-26rem)] pb-32 pt-14 flex flex-col items-center justify-center max-md:mx-12 max-md:w-[calc(100vw-6rem)]">
